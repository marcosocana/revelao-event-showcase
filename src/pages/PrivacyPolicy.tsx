    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto px-6 py-8 space-y-6">
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Los datos personales tratados son los contenidos capturados y subidos por el propio usuario
            mediante la plataforma (fotografías, vídeos y mensajes de voz), así como el email de registro
            cuando se crea un evento demo.
          </p>
        </section>

        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-foreground">3. Finalidad del tratamiento</h2>
          <p className="text-muted-foreground leading-relaxed">Los datos se tratan exclusivamente para:</p>
          ...
          <p className="text-muted-foreground leading-relaxed">
            Los contenidos no se utilizan para entrenamiento de modelos ni para fines comerciales distintos
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            aceptar estas políticas y hacer uso del servicio.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Los datos no se ceden a terceros, salvo obligación legal o proveedores tecnológicos necesarios
            para prestar el servicio bajo acuerdos de tratamiento.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            El usuario puede ejercer sus derechos de acceso, rectificación y supresión enviando una solicitud
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Revelao aplica medidas técnicas razonables para proteger los datos frente a accesos no
            autorizados durante el tiempo en que están almacenados.
          </p>
        </section>
      </main>
    </div>
