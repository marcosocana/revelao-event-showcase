...
const EventUseCaseLanding = () => {
  ...
  const normalizedSlug = useMemo(() => {
    const aliases: Record<string, string> = {
      ...
      "codigo-qr-boda": "bodas",
      "album-colaborativo-boda": "bodas",
      "subir-fotos-boda-sin-app": "bodas",
      "compartir-fotos-boda": "bodas",
      "revelado-fotos-boda": "bodas",
      "cartel-qr-boda": "bodas",
      "tarjetas-qr-boda": "bodas",
      "app-fotos-boda": "bodas",
      "whatsapp-fotos-boda": "bodas",
      "checklist-fotos-invitados-boda": "bodas",
      wedding: "bodas",
      weddings: "bodas",
      comunion: "comuniones",
  ...
  useEffect(() => {
    ...
    const titleByPath: Record<string, string> = {
      ...
      "/bodas/codigo-qr-boda": "Código QR para boda: cómo usarlo para guardar recuerdos",
      "/bodas/album-colaborativo-boda": "Álbum colaborativo de boda con fotos de invitados",
      "/bodas/subir-fotos-boda-sin-app": "Subir fotos de boda sin app | Revelao.cam",
      "/bodas/compartir-fotos-boda": "Compartir fotos de boda sin perder recuerdos",
      "/bodas/revelado-fotos-boda": "Revelado de fotos de boda | Revelao.cam",
      "/bodas/cartel-qr-boda": "Cartel QR para boda: ideas y ubicación",
      "/bodas/tarjetas-qr-boda": "Tarjetas QR para boda | Revelao.cam",
      "/bodas/app-fotos-boda": "App de fotos para boda vs QR sin app",
      "/bodas/whatsapp-fotos-boda": "Fotos de boda por WhatsApp: alternativa privada",
      "/bodas/checklist-fotos-invitados-boda": "Checklist para recopilar fotos de invitados",
    };
    const descriptionByPath: Record<string, string> = {
      ...
      "/bodas/codigo-qr-boda": "Usa un código QR en tu boda para que los invitados suban fotos, vídeos y audios sin apps ni complicaciones.",
      "/bodas/album-colaborativo-boda": "Crea un álbum colaborativo de boda con fotos, vídeos y audios aportados por todos tus invitados.",
      "/bodas/subir-fotos-boda-sin-app": "Haz que tus invitados suban fotos de la boda sin instalar ninguna app: solo escanean un QR y comparten recuerdos.",
      "/bodas/compartir-fotos-boda": "Reúne fotos de boda en una galería privada y evita conversaciones dispersas o archivos perdidos.",
      "/bodas/revelado-fotos-boda": "Convierte las fotos, vídeos y audios de tus invitados en una experiencia de revelado después de la boda.",
      "/bodas/cartel-qr-boda": "Ideas para crear un cartel QR de boda visible, claro y fácil de usar para subir fotos y vídeos.",
      "/bodas/tarjetas-qr-boda": "Usa tarjetas QR en mesas, invitaciones y detalles para recopilar recuerdos de tu boda.",
      "/bodas/app-fotos-boda": "Compara una app de fotos para boda con una galería QR sin app y elige la opción con menos fricción.",
      "/bodas/whatsapp-fotos-boda": "Descubre por qué WhatsApp no siempre es ideal para recopilar fotos de boda y cómo centralizarlas mejor.",
      "/bodas/checklist-fotos-invitados-boda": "Checklist práctica para no perder fotos de invitados: QR, carteles, recordatorios y galería privada.",
    };
